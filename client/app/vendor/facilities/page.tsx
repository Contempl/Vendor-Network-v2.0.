...
import { getFacility, createFacility, deleteFacility } from "@/entities/vendor/vendor.api";
import { VendorFacilityDto } from "@/entities/vendor/vendor-facility-types";

// TODO: напиши useEffect который при загрузке:
// 1. Берёт businessId из токена
// 2. Вызывает getFacility(businessId) 
// 3. Сохраняет в стор через setFacilities
...
export default function FacilitiesPage() {
  ...
  //   if (businessId) {
  //     getFacility(businessId).then((facilities) => {
