...
public class VendorFacilityServiceRepository : IVendorFacilityServiceRepository
{
	...
	public async Task DeleteAsync(VendorFacilityService facilityService, CancellationToken cancellationToken = default)
	{
	...
	public async Task<VendorFacilityService> GetByIdAsync(int vendorId, int facilityId, int vendorFacilityServiceId, 
		CancellationToken cancellationToken = default) => await _facilityServices.SingleAsync(vfs => vfs.Id == vendorFacilityServiceId
		&& vfs.VendorFacilityId == facilityId && vfs.VendorFacility.VendorId == vendorId, cancellationToken);

	private async Task SaveAsync(CancellationToken cancellationToken = default) => 
		await _context.SaveChangesAsync(cancellationToken);
	public async Task UpdateAsync(VendorFacilityService facilityService, CancellationToken cancellationToken = default)
	{
