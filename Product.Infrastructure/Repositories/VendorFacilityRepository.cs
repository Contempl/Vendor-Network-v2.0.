...
public class VendorFacilityRepository : IVendorFacilityRepository
{
	...
	public Task DeleteAsync(VendorFacility vendorFacility, CancellationToken cancellationToken)
	{
	...
	public Task<VendorFacility> GetByIdAsync(int vendorId, int facilityId, CancellationToken cancellationToken) => _vendorFacilities.SingleAsync(vf => vf.Id == facilityId && vf.VendorId == vendorId, cancellationToken: cancellationToken);
	public Task<VendorFacility> GetFacilityWithServicesByIdAsync(int facilityId, int vendorId, CancellationToken cancellationToken)
	{
	...
	public Task UpdateAsync(VendorFacility vendorFacility, CancellationToken cancellationToken)
	{
